package com.mcsimf.android.nuts.widget;
...
public class SnappedRecyclerView extends RecyclerView {
     ...
     * By default snapping enabled.
     *
     * @param isSnappingEnabled <code>true</code> to enable snapping,
     *                          <code>false</code> to disable snapping.
     */
    ...
    /**
     * Calculates distance that RecyclerView will scroll to
     * with fling gesture.
     * <p>
     * NOTE: Method copied from {{@link android.widget.OverScroller}}.
     *
     * @param velocity initial fling gesture velocity.
    ...
    /**
     * Calculates velocity that need to be applied to fling gesture,
     * so RecyclerView will scroll defined distance.
     *
     * @param s distance that need to be scrolled.
     * @return fling gesture velocity.
     */
    ...
    /**
     * Adjusts scrolling distance (increases or decreases)
     * so end of scrolling distance will match very beginning
